...
<title>USINA Furniture Store | Your Cart </title>
...
$coc=new crudOrders();
        ...
        $Cart=$csc->DisplayCart($csc->con,101);
        var_dump($Cart);
        foreach ($Cart as $Ca){

        $Current=$coc->DisplayCurrentOrder($coc->conn,$Ca->ID_Client);
        var_dump($Current);
...
<div class="cart_main">
	 <div class="container">
		  ...
		  <li class="active">Current Order </li>
             ...
             <table border="1" style="position: relative; align-self: center ">
    <tbody>
        <tr role="row">


          <th role="columnheader" style="width: 118px " ><h4 style="color: #1B242F ;"> Date</h4></th>
          <th role="columnheader" style="width: 170px " ><h4 style="color: #1B242F ;"> Client</h4></th>
          <th role="columnheader" style="width: 300px " ><h4 style="color: #1B242F ;"> Description</h4></th>
          <th role="columnheader" style="width: 118px " ><h4 style="color: #1B242F ;"> Quantity</h4></th>
          <th role="columnheader" style="width: 118px " ><h4 style="color: #1B242F ;"> Price/Unit</h4></th>
          <th role="columnheader" style="width: 118px " ><h4 style="color: #1B242F ;"> Price</h4></th>
