...
<html>
    <head>
        <title>L'usina:: Single Product</title>
...
<?php session_start(); ?>                        
            ...
            <div class="container">
                ...
                <div class="col-md-9 det">
                    ...
                    <div class="single-right">
                        ...
                        <div class="id" ><h4>ID: 2000</h4></div>
                        <form action="AddMark.php" class="sky-form" method="POST" id="ratings">
                            <input type="text" name="Ref_Model" value="2000" hidden>
                            <fieldset>					
                                <section>
                                    <div class="rating">

                                        <input type="radio" name="stars-rating" id="stars-rating-1" value="0">
                                        <label for="stars-rating-1"><i class="icon-star"></i></label>
                                        <input type="radio" name="stars-rating" id="stars-rating-2" value="1">
                                        <label for="stars-rating-2"><i class="icon-star"></i></label>
                                        <input type="radio" name="stars-rating" id="stars-rating-3" value="2" >
                                        <label for="stars-rating-3"><i class="icon-star"></i></label>
                                        <input type="radio" name="stars-rating" id="stars-rating-4" value="3">
                                        <label for="stars-rating-4"><i class="icon-star"></i></label>
                                        <input type="radio" name="stars-rating" id="stars-rating-5" value="4">
                                        <label for="stars-rating-5"><i class="icon-star"></i></label>
                                        <input type="radio" name="stars-rating" id="stars-rating-6" value="5" hidden checked>
                                        <div class="clearfix"></div>

                                    </div>
                                </section>
                            </fieldset>
                            <input type="submit" value="Rate" class="test" >
                            <?php
                            if (isset($_POST['stars-rating'])) {
                                ?>

                                <script type="text/javascript">
                                    document.getElementById('ratings').submit(); // SUBMIT FORM
                                </script>

                                <?php
                            } else if (!isset($_POST['stars-rating'])) {
                                ?>
                                <div><h3> Here </h3></div>  
                                <?php
                            }
                        ...
                        <div class="cost">
                            <div class="prdt-cost">
                                <ul>
                                    <li>MRP: <del>5500 TND</del></li>								 
                                    <li>Selling Price:</li>
                                    <li class="active">3500 TND</li>
                                    <a href="#">BUY NOW</a>
                                </ul>
                            </div>
                            <div class="check">
                        ...
                        <div class="item-list">
                            <ul>
                                ...
                                <li>Brand: L'usina Original design</li>
                                <li><a href="#">Click here for more details</a></li>
                            </ul>
                        </div>
                        <div class="single-bottom1">
                            <h6>Details</h6>
                            <p class="prod-desc">A contemporary design that suits all tastes, with a classic touch with the black leather.</p>
                        </div>					 
                    </div>
                    <div class="clearfix"></div>
                    <div class="sofaset-info">
                        ...
                        <div>
                            <form action="AddMark.php" class="sky-form" method="POST">
                                <input type="text" name="Ref_Model" value="2000" hidden>
                                <fieldset>					
                                    <section>
                                        <div class="rating">
                                            ...
                                            $cc = new CrudMark();
                                            $avg_marks = $cc->averageMarks($cc->conn);
                                            //var_dump($avg_marks);
                                            foreach ($avg_marks as $avg) {
                                ...
                                <input type="text" value="<?php echo $avg['avg']; ?>" style="border:none" readonly>
                                <br>
        ...
        <div class="footer">
            <div class="container">
                ...
                <div class="copywrite">
                    <p>Copyright © 2016 L'Usina All rights reserved | Design by Hypernova</a></p>
                </div>			 
            </div>
        </div>
    </div>
