...
<script src="js/recherchePourcentageajax.js"> </script>
...
<div class="top_bg">
	<div class="container">
		<div class="header_top-sec">
			...
			<div class="top_left">
				<ul>
					<!-- <li class="top_link">Email: <a href="mailto@example.com">//<?php// echo $_SESSION['email']?></a></li> -->
...
<li><a class="color6" href="IndexLoggedIn.php?offres">Offres</a></li>				
					 ...
					 /***Pour resultat recherche pourcentage**/
						 if(isset($_POST['ok']))
						{
							...
							foreach($res as $values) 
												...
												<div class="product-grid love-grid"><a href="single.html">
						...
						<!--debut de bloc-->
						   ...
						   <img src="images/<?php echo $values['photo']?>" class="img-responsive" alt="">
						...
						<div class="product-info simpleCart_shelfItem">
							<div class="product-info-cust prt_name">
								...
								<span class="item_price"><?php echo $values['Price']?> </span>	<font color="red"><?php echo $values['pourcentage']?></font>							
