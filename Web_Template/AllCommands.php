...
<div class="rsidebar span_1_of_left">
 ...
 <div class="Account">
         <div class="col-md-6 log">	
                   <!--Commands Control Location-->
                   <?php
                    include ("./Crud_Orders.php");
$cc=new crudOrders();
/*if (isset($_POST["supprimer"])){
	$cc->DeleteOrder($_POST["ID_Order"],$cc->conn);
	
}*/
        $cin=12667796;
	$liste=$cc->DisplayOrderByID($cin,$cc->conn);
	var_dump($list);
	?> 
	<table border="1">
	<tr>
	<td>ID</td><td>Date</td><td>Price</td><td>Commandline</td><td>Image</td>
	</tr>
	<?php
	foreach ($liste as $l){
         ?>
	<tr>
	<td><?php echo $l['ID_Order'] //$l[1]?></td>
	<td><?php echo $l['Order_Date'] //$l[2]?></td>
	<td><?php echo $l['Order_Price']//$l[3] ?></td>
	<td><?php echo $l['ID_Cmdline'] //$l[0]?></td>
        <td><?php echo '<img src="data:image/jpg;base64,'.base64_encode( $l['Image'] ).'"/>'?>;</td>
	</tr>
	<?php
	}
	?>
