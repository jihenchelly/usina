			...
			<div class="top_left">
				<ul>
					<li class="top_link">Email:<a href="mailto@example.com">info@atebtunisie.com</a></li>|
                                        <li class="top_link"><a href="account.php"> My Account</a></li>|					
				</ul>
				<div class="social">
					<ul>
...
<div class="mega_nav">
 ...
 <li><a class="color5" href="?offres"">Offers</a>	
	 ...
	 <div class="container">
		 <div class="sofas">
			 <div class="col-md-6 sofa-grid">
				 ...
				 <h4><a href="products.html">SPECIAL OFFERS</a></h4>
			 </div>
			 <div class="col-md-6 sofa-grid sofs">
				 <img src="images/t2.jpg" alt=""/>
				 <h3>SPECIAL DESIGN FURNITURE</h3>
				 <h4><a href="products.html">CUSTOMIZABLE PRODUCTS</a></h4>
			 </div>
			 <div class="clearfix"></div>
		 </div>
	 </div>
...
<div class="new">
	 <div class="container">
		 <h3>Contemporary Style by L'Usina </h3>
		 <div class="new-products">
		 <div class="new-items">
			 <div class="item1">
				 <a href="products.html"><img src="images/s1.jpg" alt=""/></a>
				 <div class="item-info">
					 <h4><a href="products.html">Clocks Collection</a></h4>
					 <span>ID: SR5421</span>
			 ...
			 <div class="item4">
				 <a href="products.html"><img src="images/s4.jpg" alt=""/></a>
				  <div class="item-info4">
					 <h4><a href="products.html">Dinning Table</a></h4>
					 <span>ID: SR5421</span>
					 <a href="single.html">Buy Now</a>
				 </div>			 
			 </div>
		 ...
		 <div class="new-items new_middle">
			 <div class="item2">			 
				 <div class="item-info2">
					 <h4><a href="products.html">Funky Salon</a></h4>
					 <span>ID: GS7641</span>
					<a href="single.html">Buy Now</a>
				 </div>
			 ...
			 <div class="item5">	
				 ...
				 <div class="item-info5">
					 <h4><a href="products.html">Bar Assortments </a></h4>
					 <span>ID: SR5421</span>
					 <a href="single.html">Buy Now</a>
				 </div>	
			 </div>
		 ...
		 <div class="new-items new_last">
			 <div class="item3">	
				 ...
				 <div class="item-info3">
					 <h4><a href="products.html">White Velvet Sofa</a></h4>
					 <span>ID: SR5421</span>
					 <a href="single.html">Buy Now</a>
				 </div>			 
			 </div>
			 <div class="item6">	
				 ...
				 <div class="item-info6">
					 <h4><a href="products.html">Bedroom Set</a></h4>
					 <span>ID: SR5421</span>
					 <a href="single.html">Buy Now</a>
				 </div>
	 ...
	 <div class="container">
		 ...
		 <div class="seller-grids">
			 <div class="col-md-3 seller-grid">
				 ...
				 <h4><a href="products.html">Table Collection circle</a></h4>
				 <span>ID: DB4790</span>
				 <p>Rs. 500/-</p>
			 </div>
			 <div class="col-md-3 seller-grid">
				 <a href="products.html"><img src="images/ts11.jpg" alt=""/></a>
				 <h4><a href="products.html"></a>Entrance Furniture</h4>
				 <span>ID: BR4822</span>
				 <p>Rs. 1000/-</p>
			 </div>
			 <div class="col-md-3 seller-grid">
				 <a href="products.html"><img src="images/ts3.jpg" alt=""/></a>
				 <h4><a href="products.html">Table Collection square</a></h4>
				 <span>ID: LF8560</span>
				 <p>Rs. 450/-</p>
			 </div>
			 <div class="col-md-3 seller-grid">
				 <a href="products.html"><img src="images/ts4.jpg" alt=""/></a>
				 <h4><a href="products.html">Home Mirror </a></h4>
				 <span>ID: DB4790</span>
				 <p>Rs. 180/-</p>
			 </div>
			 <div class="clearfix"></div>
