...
$id=$_GET['refm'];
	...
	$list=$cc->afficheproduitselonid($cc->conn,$id);
...
<div class="single-sec">
    ...
    ?>
							...
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="<?php echo $l['photo']?>" class="img-responsive" />
									<img class="etalage_source_image" src="<?php echo $l['photo']?>" class="img-responsive" title="" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="<?php echo $l['photo']?>" class="img-responsive" />
						    ...
						    <li>
								<img class="etalage_thumb_image" src="<?php echo $l['photo']?>" class="img-responsive"  />
								<img class="etalage_source_image" src="<?php echo $l['photo']?>"class="img-responsive"  />
							</li>
						 </ul>
						  <div class="clearfix"></div>
						 <?php 
    ...
    ?>
				  ...
				  <div class="single-right">
					 ...
					 <div class="id"><h4>ID: <?php echo $l['Ref_Model']; ?></h4></div>
					  ...
					  <div class="cost">
						 <div class="prdt-cost">
							 <ul>
								 ...
								 <li>Selling Price:</li>
								 <li class="active"><?php echo $l['Price']; ?> TND</li>
					  ...
					  <div class="single-bottom1">
						<h6>Details</h6>
						<p class="prod-desc"><?php echo $l['description']; ?></p>
					 </div>					 
				  </div>
				  <div class="clearfix"></div>
				  <div class="sofaset-info">
						 <h4>Product Summary : <?php echo $l['Name']; ?></h4>
						 <ul>
					<?php if($l['diametre']==0) { ?>		 <li>Rectangular Shape : Dimensions: Length <?php echo $l['length']; ?> cm x Width <?php echo $l['width']; ?> cm x Height <?php echo $l['height']; ?> cm </li>
					<?php } ?>	

<?php if($l['diametre']!=0) { ?>		 <li>Rounded Shape: Dimensions: Diametre <?php echo $l['diametre']; ?> cm  x Height <?php echo $l['height']; ?> cm </li>
					<?php } ?>
					<li>Assembly Type: Pre Assembled</li>
							 ...
							 <li>Available in following colors: <?php 
					
					$listcouleurs=$cc->affichecouleur($cc->conn,$id);
						 foreach ($listcouleurs as $c)
	
	{
		 echo $c['ID_Color']." "; 
						     ...
						     <li>Offers <?php echo $l['pt_value']  ?> Fidelity points to your account. </li>
