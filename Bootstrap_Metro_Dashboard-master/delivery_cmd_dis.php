...
$cc->finishDelivery($_POST["cinD"],$_POST["idd"],$cc->conn);
}
$list=$cc->displayDelivery($cc->conn);
	?> 
	...
	<table>
	<tr>
	<td>ID delivery</td><td>state</td><td>order date </td><td>first name</td><td>last name</td><td>ID order</td><td>destination</td><td>driver</td><td></td>
	</tr>
	<?php
	foreach ($list as $l){
	...
	<?php
	if($l['state']=="in progress"||$l['state']=="finished")
	{echo '<td>'.$l['cin_driver'].'</td> ';
	}
   ?>
	...
	if($l['state']=="pending")
	{?>
	<td><a  href="modifdelivery.php?id_delivery=<?php echo $l['id_delivery']."&destination=".$l['destination'];?>" title="launch" name="launch " class="icon-truck"></a><td>
	<?php
	}
	else if ($l['state']=="in progress"){
		?>		
	<td><a  onclick=" return confirm('Are you sure ?') " href="finish.php?id_delivery=<?php echo $l['id_delivery']."&cinD=".$l['cin_driver'];?>" title="set finished" name="set finished " class="glyphicons-icon ok"></a><td>
	<!--<script>
$(function () {
$(".glyphicons-icon ok").click(function (e) {
...
-->
	...
	<?php
	echo '<td><input type="text" value="'.$l['id_delivery'].'" name="idd" style="display: none;"></td>';
	echo '<td><input type="text" value="'.$l['cin_driver'].'" name="cinD" style="display: none;"></td>';}
	?>
	</form> </td>
	</tr>
	<?php
