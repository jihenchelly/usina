...
function charts() {
    ...
    function randNum() {
        return ((Math.floor(4 * (1 + 40 - 20))) + 20) * 120;
    }

    function randNum2() {
        return ((Math.floor(Math.random() * (1 + 40 - 20))) + 20) * 50;
    }

    function randNum3() {
        return ((Math.floor(5 * (1 + 40 - 20))) + 20) * 30;
    }

    function randNum4() {
        return ((Math.floor(1 * (1 + 40 - 20))) + 20) * 10;
    }
    ...
    if ($("#stats-chart2").length)
    {
        ...
        var plot = $.plot($("#stats-chart2"),
            ...
            xaxis: {ticks: 10, tickDecimals: 0, color: "rgba(255,255,255,0.8)"},
