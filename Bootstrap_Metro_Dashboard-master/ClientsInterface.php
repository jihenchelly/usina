	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				...
				<div class="header">
                                <h1>Clients Display and Deletion </h1>
                                <input placeholder="Search..." type="text" id="search" oninput="recherche()">
...
var q=document.getElementById("search").value;
    ...
    oReq.onload = function() {
		...
		document.getElementById("txtHint").innerHTML = this.responseText; //afficher résultat de la recherche dans la même div que celle de l'affichage
    	
		
    };
    oReq.open("GET", "php/Search.php?q="+q, true); //se diriger le fichier avec le paramètre q 
...
$cc=new CrudClient();
$list=$cc->displayClient($cc->conn);
	?> 
	<table>
	<tr>
	<td>ID</td><td>First Name</td><td>Last name</td><td>Sex</td><td>Email</td><td></td><td></td> <td></td> <td></td> <td></td> <td></td> <td></td>
	</tr>
	<?php
	foreach ($list as $l){
    ?>
	...
	<td><?php echo $l['Street']?> </td>
        <td><?php echo $l['Region']?> </td>
        <td><?php echo $l['Phone']?> </td>
        <td><form method='POST' action="php/deleteClient.php" >
                <td><button type="submit" value="Delete" name="delete" onclick="return confirm('Are you Sure ?')" class="btn btn-primary"> Ban Client</button> </td>
                <td> <a href="mail2.php?email=<?php echo $l['Email']?>" class="btn btn-primary">Send Mail</a></td>
