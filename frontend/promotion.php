...
<div class="mega_nav">
	 <div class="container">
		 ...
		 <ul class="megamenu skyblue">
			 <li class="active grid"><a class="color1" href="?promotion">Home</a></li>
			...
			<li><a class="color4" href="#">Accessories</a>
				...
				<li><a class="color6" href="#">Our Achievements</a></li>
					...
					<?php
					 /***Pour resultat recherche pourcentage**/
						 if(isset($_POST['ok']))
						{
							$row=count($res);
							if($row==0)
								echo '<h1>Pas de produit pour votre recherche</h1>';
							else{
