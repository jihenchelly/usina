        ...
        location.href = "MyAccountSettings.html";
			 ...
			 <!-- Form -->
				<form id="registration_form" action="AddClient.php" method="POST">
					<div>
						<label>
							<input name="First_Name" placeholder="first name:" type="text" tabindex="1" required autofocus>
						</label>
					</div>
					<div>
						<label>
							<input name="Last_Name" placeholder="last name:" type="text" tabindex="2" required autofocus>
						</label>
					</div>
					<div>
						<label>
		 ...
		 <div class="registration_left">
			 ...
			 <!-- Form -->
				...
				<form id="registration_form" action="cnx.php" method="post">
					<div>
						<label>
					...
					<div>
						<label>
							<input placeholder="password" type="password" name="mdp" tabindex="4" required>
						</label>
					</div>						
					<div>
						<input type="submit" value="sign in" name="ok" id="register-submit">
					</div>
					<div class="forget">
