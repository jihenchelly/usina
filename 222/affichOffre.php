...
<head>
	<script src="js/jquery-1.9.1.min.js"></script>
		<script src="js/rechercheajaxOffre.js"></script>
	<?php
	include ("php/crudoffre.php");


$offre=new crudOffres(); //cnx déjà établie dans le constructeur  
$resultas=$offre->getOffres();
if(isset($_GET['modif']))
{$detail=$offre->detailOffre();}
if(isset($_GET['param']))
{
	if($offre->supprimerOffre())
	header("location:affichOffre.php");
else print 'nono';
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="index.php?newsletter"><i class="icon-bar-chart"></i>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Generate Offers</h2>
						<div class="box-icon">
					 ...
					 <div class="box-content" >
						...
						<?php if(isset($_GET['modif']))
						{
							...
							foreach($detail as $code);
							?>
					  <form method="POST" class="form-horizontal" enctype="multipart/form-data">
						  <fieldset>
						  				
							  <div class="control-group">
								<label class="control-label" for="focusedInput">Type d'offre </label>
								<div class="controls">
								  <input class="input-xlarge focused" id="Promo_Name_add" name="type" value="<?php echo $code['Type']?>" type="text">
								</div>
							  </div>
						<div class="control-group">
							  <label class="control-label" for="date01">Date Begin</label>
							  <div class="controls">
								<input type="date"  id="dateD_promo_add" name="dateD_promo_add" value="<?php echo $code['Offer_Start_Date']?>">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="date01">Date End</label>
							  <div class="controls">
								<input type="date"  id="dateF_promo_add" name="dateF_promo_add" value="<?php echo $code['Offer_End_Date']?>">
							  </div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
								  <input type="text" name="idProduit_promo_add" value="<?php echo $code['Name_Category']?>" readOnly/>
							  ...
							  <div class="control-group">
							  <img src="img/images_offre/<?php echo $code['photo_offre']?>" width="80" height=70 style="position:relative; left:50px;"/>
							  <label class="control-label" for="fileInput" style="position:relative;top:80px;" >choose photo</label>
							  <div class="controls">
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" name="description"  " id="textarea2" rows="3"><?php echo $res['description_offre']?></textarea>
							  </div>
							</div>		
